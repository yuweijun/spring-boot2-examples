...
public class SwaggerConfig {
    ...
    private ApiInfo metadata() {
        String description = "This is a sample JWT authentication service. " +
                ...
                "you should click on the right top button `Authorize` and introduce it with the prefix \"Bearer \", like: " +
                "`Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbiIsImF1dGgi.D-5wvIc2pnr_JYF60TAca5_na4v4hNx7eKGb7v9Wa-I`";
        return new ApiInfoBuilder()
                .title("JSON Web Token Authentication API")
                .description(description)
                .version("1.0.0")
                .license("MIT License").licenseUrl("http://opensource.org/licenses/MIT")
                .contact(new Contact(null, null, "test.yu@gmail.com"))
                .build();
    }
