...
public class EmployeeSpringFunctionalIntegrationTest {
    ...
    public void givenEmployeeId_whenGetEmployeeById_thenCorrectEmployee() {
        WebTestClient client = WebTestClient
                .bindToRouterFunction(config.getEmployeeByIdRoute(employeeRepository))
                .build();
    ...
    public void whenGetAllEmployees_thenCorrectEmployees() {
        WebTestClient client = WebTestClient
                .bindToRouterFunction(config.getAllEmployeesRoute(employeeRepository))
                .build();
    ...
    public void whenUpdateEmployee_thenEmployeeUpdated() {
        WebTestClient client = WebTestClient
                .bindToRouterFunction(config.updateEmployeeRoute(employeeRepository))
                .build();
